...
public class HelloWorldExample02 {
	public static void main(String[] args) {
		...
		builder.stream("hello-world")
				// Es werden i.R. key und value übergeben, man muss dann meist auch beides zurückgeben
				// -> Werkzeug sind dann KeyValue, statische Methode pair erlaubt schnelles Erzeugen
